...
///
/// Deliberately narrower than the platform plugin's API. The feed layer owns
/// this contract; an adapter maps the plugin onto it. That keeps `lib/feed/`
/// free of Flutter and lets the reconnect tests drive connectivity by hand.
